...
- **`index.html`** is the main planting calendar, covering 229 plants across 17 segments.
- **`peppers.html`** is a dedicated pepper guide, covering 47 varieties across the five domesticated Capsicum species, with heat levels, a pepper-specific conditions readout, overwintering, drying and hot sauce. Peppers get their own page because Florida grows them unusually well and because cultivar detail matters more here than it does for most crops.
...
`peppers.html` is a standalone companion, organised by species rather than by heat, because species predicts germination speed, days to maturity, heat tolerance and what will cross with what. Datil and habanero behave alike in the garden because they are the same species, whatever the labels suggest.

It covers 47 varieties with logarithmic heat scaling, a sowing and harvest calendar for the three regions, a conditions tab that reads soil temperature and reports which species you can start today, a section on why flowers drop, overwintering (peppers are perennial in most of Florida and a second-year plant substantially outproduces a first-year one), harvest and drying for a humid climate, fermented hot sauce including the acidity threshold that matters, and seed saving with isolation guidance for keeping a heritage line such as Datil true.

It has no photo layer, deliberately. Cultivars are not separate taxa in the photo databases, so every Capsicum annuum variety would return the same image. A ripe-pod colour chip and a heat bar carry more information than a generic species photo would.
